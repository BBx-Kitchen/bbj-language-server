 ...
 * params and result (#571). {@code bbj-vscode/src/language/compile-command.ts} is the
 ...
 * The client dispatches on this value, never on {@code CompileResult.message} prose.
 */
