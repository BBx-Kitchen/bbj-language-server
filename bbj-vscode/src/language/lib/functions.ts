...
@/
ADJN(param:num, ERR?:lineref): string
...
@/
DECRYPT(param: string, param: string, ERR?:lineref): string
...
@/
LOG(param: num, param: int, ERR?: lineref): num
...
@/
RESINFO(param: res_handle, param: string, ERR?:lineref): string
...
@/
ROUND(param: num, param: int, ERR?:lineref): num
...
@/
SCALL(param: string, ERR?:lineref): int
...
@/
SQLERR(param: sqlchannel, ERR?:lineref): string
...
@/
SSZ(param: string, ERR?:lineref): int
SSZ(param: int, ERR?:lineref): int
...
@/
STBL(param: string, param: string, ERR?:lineref): string
...
@/
SWAP(param: string, param: string, ERR?:lineref): string
...
@/
TBL(param: string, table: string, ERR?:lineref): string
TBL(param: string, TBL?:lineref, ERR?:lineref): string
...
@/
WININFO(param: sysgui, param: int, ERR?:lineref, END?:lineref): string
...
@/
XOR(param: string, param: string, ERR?:lineref): string
