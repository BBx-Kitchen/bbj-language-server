...
`EASY-FIXES.md`, or the phase directory's own script and SUMMARY files (the sole hit anywhere in
the phase directory is `68-07-PLAN.md`'s own authored prohibition, which names those three
