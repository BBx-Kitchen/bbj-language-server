...
Add `CancellationToken` to the langium import. It's already available from langium. The existing imports already include `DocumentValidator`, `LangiumDocument`, `Diagnostic`, and `DiagnosticSeverity`.
