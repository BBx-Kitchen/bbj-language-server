...
[testing paused — 1 item outstanding: test 4 blocked on G-81-3]
...
result: blocked
blocked_by: other
reason: "with the setting not there, I think we should also defer this uat test (depends on gap G-81-3 / test 3)"
