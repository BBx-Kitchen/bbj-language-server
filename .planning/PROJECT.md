...
- [ ] Config file changes (PREFIX, project-wide USE, custom config path) and Java class refreshes take effect without a manual language-server restart, and the configured file is treated as a config file in the editor — Phase 84 delivered the config-path half (CFG-01, CFG-02: one shared resolver, every consumer honors the configured file, config-file treatment in both IDEs); hot-reload (CFG-03) and the interop refresh (CFG-04) remain for Phases 85-86
...
---
*Last updated: 2026-09-06 after Phase 84*
