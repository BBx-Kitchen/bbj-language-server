...
**Current state:** v4.3 Polish & Quality started 2026-09-06, scoped to the 23 issues on GitHub milestone #5; Phases 84-89 complete (Phase 89 — composer cues, MSGBOX expression options and the CVS() composer — verified 2026-09-12 after one UAT gap-closure round), next is Phase 90 (composer robustness & IntelliJ composer performance); 19 milestones shipped. v4.2 landed on `origin/main` via PR #651 (preview 0.12.28). Whole-suite vitest green at `numFailedTests: 0` (~1,127 tests); IntelliJ JUnit suite green (504+ tests, grown further by Phase 87's PreviewDebouncer/DecodeEquality/ComposerLauncher SETOPTS additions). All nine known advisory fixes merged; publication awaits a tagged release.
...
---
*Last updated: 2026-09-12 after Phase 89*
