...
**Current state:** v4.3 Polish & Quality started 2026-09-06, scoped to the 23 issues on GitHub milestone #5; Phases 84-91 complete (Phase 91 — workspace-size-independent scope lookups, java-interop circuit breaker with request-driven recovery, LRU eviction race, per-request completion cancellation — verified 2026-09-13 with the live outage-and-recovery UAT passing 1/1 on the first round), next is Phase 92 (host-side hygiene & focus guards), the last v4.3 phase; 19 milestones shipped. v4.2 landed on `origin/main` via PR #651 (preview 0.12.28). Whole-suite vitest green at `numFailedTests: 0` (1,855 tests, 29 skipped); IntelliJ JUnit suite green (846 tests after Phase 90's code-review fixes). All nine known advisory fixes merged; publication awaits a tagged release.
...
---
*Last updated: 2026-09-13 after Phase 91*
