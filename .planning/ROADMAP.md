...
- [x] 92-02-PLAN.md — Format requests share an in-flight run only for identical text, so interim edits never receive output formatted from older text (RESP-06)
- [x] 92-03-PLAN.md — Both IntelliJ status-bar widgets follow bare tab switches through one file-type decision that hides the config file whatever its name (RESP-09)
