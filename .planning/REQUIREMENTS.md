...
- [x] **DOC-03**: Both documents state review coverage explicitly — modules reviewed, dimensions applied, and what was excluded — so coverage gaps are visible to a reader
