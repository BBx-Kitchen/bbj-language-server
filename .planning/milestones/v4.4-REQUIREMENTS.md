# Requirements Archive: v4.4 IntelliJ Focus
...
- [x] **REL-01**: Release 0.16.0 is published to both the VS Code Marketplace and JetBrains Marketplace through SEED-002's single verification gate, with no half-released version and no orphaned tag
- [x] **REL-02**: All 21 issues on GitHub milestone #7 are closed and the milestone itself is closed
...
| REL-01 | Phase 97 | Complete |
| REL-02 | Phase 97 | Complete |
