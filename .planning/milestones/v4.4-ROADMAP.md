...
- [x] **Phase 97: Release 0.16.0 & Milestone Close** - 0.16.0 published to both marketplaces behind one verification gate, with GitHub milestone #7 closed (completed 2026-09-20)
...
**Plans**: 11/11 plans executed (six pending todos folded in at discuss time — a code wave precedes the release)
...
- [x] 97-06-PLAN.md — REL-01: branch synced with `origin/main` without a version regression, one landing PR, maintainer review and squash merge (wave 4)

**Wave 5** *(blocked on 97-06)*

- [x] 97-07-PLAN.md — REL-01: reconciliation runbook, green Preview run, maintainer preview hand check in both IDEs (wave 5)

**Wave 6** *(blocked on 97-07)*

- [x] 97-08-PLAN.md — REL-01: precondition report, maintainer dispatches Manual Release 0.16.0, run watched and release evidence recorded (wave 6)

**Wave 7** *(blocked on 97-08)*

- [x] 97-09-PLAN.md — REL-01: curated release notes drafted, approved, applied (wave 7)

**Wave 8** *(blocked on 97-09)*

- [x] 97-10-PLAN.md — REL-01: pre-filled smoke checklist, maintainer smoke of the released artifacts, verdict tied to their hashes (wave 8)

**Wave 9** *(blocked on 97-10)*

- [x] 97-11-PLAN.md — REL-02: 21 closing comments drafted and approved, issues closed one at a time, milestone #7 closed, folded todos moved to completed (wave 9)
...
**Total:** 20 milestones shipped, 95 phases complete, 349 plans shipped.
...
**Current milestone:** v4.4 IntelliJ Focus (Phases 93-97) — complete, started 2026-09-17, shipped
2026-09-20. 25/25 requirements mapped and complete, 5/5 phases complete. Scope was GitHub
milestone #7's 21 IntelliJ issues, the two carried Node.js todos, and the 0.16.0 release, all
delivered — release 0.16.0 published to both marketplaces and milestone #7 closed (0 open, 21
closed). See `.planning/REQUIREMENTS.md` for the requirement list and `.planning/PROJECT.md` for
scope.
Next: `/gsd-complete-milestone` to archive v4.4 and start the next milestone cycle.
